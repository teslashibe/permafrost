...
export const demoData: DemoData = {
  ...
  recent_decisions: [
    ...
    {
      id: 'd-tao-1',
      agent_id: 'ag-tao-dca-05',
      ts: ts(22_000),
      confidence: 1.0,
      notes: 'alpha_dca: buying 1 TAO each of [SN8, SN3, SN19]',
      num_orders: 0,
      num_swaps: 3,
      llm_used: false,
    },
    {
      id: 'd-mo-1',
      agent_id: 'ag-mo-momentum-06',
      ts: ts(33_000),
      confidence: 0.7,
      notes: 'alpha_momentum: holding 5 subnets, 1 entry (SN64), 1 exit (SN12)',
      num_orders: 0,
      num_swaps: 2,
      llm_used: false,
    },
    {
      id: 'd-yumi-1',
      agent_id: 'ag-yumi-yield-07',
      ts: ts(40_000),
      confidence: 0.7,
      notes: 'alpha_yield: rebalance → top 3 by stability {SN8, SN1, SN3}',
      num_orders: 0,
      num_swaps: 4,
      llm_used: false,
    },
...
const DEMO_TEMPLATES: Array<Omit<DecisionLite, 'id' | 'ts'>> = [
  ...
  { agent_id: 'ag-tao-dca-05', confidence: 1.0, notes: 'alpha_dca: buying 1 TAO of [SN8, SN3, SN19]',
    num_orders: 0, num_swaps: 3, llm_used: false },
  { agent_id: 'ag-mo-momentum-06', confidence: 0.7, notes: 'alpha_momentum: SN64 +12% momentum → enter',
    num_orders: 0, num_swaps: 1, llm_used: false },
  { agent_id: 'ag-yumi-yield-07', confidence: 0.7, notes: 'alpha_yield: SN8 stability rank #1, holding',
    num_orders: 0, num_swaps: 0, llm_used: false },
];
